  ...
  workplace: [
    {
      ...
      options: [
        "Pretend you get it",
        "Ask: “Can I repeat this back to you?”",
        "Stay silent",
        "Blame someone else"
      ],
      correct: 1
    ...
    {
      q: "What is a healthy workplace boundary?",
      options: [
        "Never saying no",
        "Letting coworkers control your time",
        "Separating personal and work issues",
        "Doing everyone’s job"
      ],
      correct: 2
    },
    {
      q: "What helps reduce workplace stress?",
      options: [
        "Ignoring problems",
        "Taking short breaks",
        "Yelling",
    ...
    {
      q: "What is a good way to handle conflict?",
      options: [
        "Avoid it forever",
    ...
    },
    {
      ...
      options: [
        ...
        "Doing tasks randomly",
        "Only working when watched"
      ],
      correct: 1
    },
    {
      q: "What is a sign of good communication?",
      options: [
        "Clear and respectful messages",
        "Talking nonstop",
